...
function Features() {
    ...
    return (
        <div id='features' className='flex flex-col items-center my-10 scroll-mt-12'>
            ...
            <Title title='Biuld your resume' description='Our streamline process helps you to create a professional resume in minutes with intelligence AI-powered tools and featured.'/>
