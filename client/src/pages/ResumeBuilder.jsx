...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, LucideScanEye, Share2Icon, Sparkles, User } from 'lucide-react'
...
const ResumeBuilder = () => {
  ...
  const saveResume = async () => {
    try {
      ...
      //reomove image from updated resume data
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='lg:col-span-7 max-lg:mt-6'>
            <div className='relative w-full'>
              <div className='absolute buttom-3 left-0 right-0 flex items-center justify-end gap-2'>
                {resumeData.public && (
                  <button onClick={handleShare} className='flex items-center p-2 px-4 gap-2 textxs bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-lg ring-blue-300 hover:ring transition-colors'>
                ...
                <button onClick={downloadResume} className='flex items-center  px-6 gap-2 py-2 text-xs bg-gradient-to-br from-green-100 to-green-200 text-green-600 ring-green-300 rounded-lg hover:ring transition-colors'>
